  ...
  return (
    <Layout>
      <section className="container-wide pt-20 lg:pt-28 pb-24">
        <p className="text-[11px] uppercase tracking-eyebrow text-secondary mb-6">Enquiries</p>
        ...
        <div className="container-wide py-20 lg:py-28 grid grid-cols-1 lg:grid-cols-12 gap-16">
          <div className="lg:col-span-5 space-y-12">
            ...
            <div>
              ...
              <a href="mailto:hello@sableandstone.gh" className="font-display text-2xl hover:text-secondary block">
                hello@sableandstone.gh
              </a>
              <a href="tel:+233300000000" className="font-display text-2xl hover:text-secondary block mt-1">
                +233 (0) 30 000 0000
              </a>
            </div>
            <div>
          ...
          >
            ...
            <div className="sm:col-span-2 pt-4">
              <button
                type="submit"
                className="inline-flex items-center px-10 py-4 text-[11px] uppercase tracking-eyebrow bg-foreground text-background hover:bg-secondary hover:text-secondary-foreground transition-colors"
              >
                Send enquiry
              </button>
            </div>
